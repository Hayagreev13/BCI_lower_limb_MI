...
def run_ol_exp(subject):
    ...
    # creating cue list
    img_list = [('./cues/VC_Relax.jpg',0),('./cues/VC_Right.jpg',1),('./cues/VC_Left.jpg',2),('./cues/VC_Legs.jpg',3)]*2
    trials = len(img_list)
        ...
        if len(times) == 0: #times is a multiple of sampling frequency as we show 10 secs of initial screen
            ...
            for cue in img_list:
                ...
                if cue_cls == 0:
                    ...
                    temp = 4*Fs*['Z']+4*Fs*['legs']+8*Fs*[3]+4*Fs*['rest']
                    classes = classes + temp
